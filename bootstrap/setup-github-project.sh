...
echo ""
echo "  ⚠️  Manual step required — configure Status field options:"
echo "     GitHub Projects has a built-in 'Status' field whose options"
echo "     must be updated manually to match the 7-state taxonomy:"
echo ""
echo "     1. Open the project: ${PROJECT_URL}"
echo "     2. Click the 'Status' column header → 'Edit field'"
echo "     3. Delete default options (Todo, In Progress, Done)"
echo "     4. Add these options in order:"
echo "         🔲 Backlog"
echo "         ✅ Ready"
echo "         🔄 In Progress"
echo "         👀 In Review"
...
echo ""
echo "  Copilot Suitable field (Yes/Partial/No) maps 1:1 to labels:"
echo "     Copilot Suitable = Yes     ↔  label: Copilot: Yes"
echo "     Copilot Suitable = Partial ↔  label: Copilot: Partial"
echo "     Copilot Suitable = No      ↔  label: Copilot: No"
echo "  Set both field and label on each issue for full KPI tracking."
echo ""
